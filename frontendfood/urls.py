...
urlpatterns = [
    ...
    path('booktable_save_fd/',views.booktable_save_fd,name="booktable_save_fd"),
    ...
    path('Reviewpage/',views.review_pg_fd,name="Reviewpage"),
    path('Reviewadd/',views.review_save_fd,name="Reviewadd"),
